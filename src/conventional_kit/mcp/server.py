...
from conventional_kit.branch import grammar as branch_grammar
from conventional_kit.branch import rules as branch_rules
from conventional_kit.branch import vocabulary as branch_vocab
from conventional_kit.commit import grammar as commit_grammar
from conventional_kit.commit import rules as commit_rules
from conventional_kit.commit import vocabulary as commit_vocab

mcp = FastMCP("conventional-kit")
