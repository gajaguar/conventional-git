...
[![CI](https://img.shields.io/github/actions/workflow/status/gajaguar/conventional-kit/ci.yml?style=flat-square&label=ci)](https://github.com/gajaguar/conventional-kit/actions/workflows/ci.yml)
[![Python CI](https://img.shields.io/github/actions/workflow/status/gajaguar/conventional-kit/python.yml?style=flat-square&label=python)](https://github.com/gajaguar/conventional-kit/actions/workflows/python.yml)
[![License](https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square)](LICENSE)
[![Python](https://img.shields.io/badge/python-%3E%3D3.14-blue.svg?style=flat-square)](pyproject.toml)
[![Topics](https://img.shields.io/badge/topics-pre--commit%20%7C%20mcp%20%7C%20conventional--commits%20%7C%20conventional--branch%20%7C%20validation-informational?style=flat-square)](https://github.com/gajaguar/conventional-kit)
...
```bash
git clone https://github.com/gajaguar/conventional-kit
cd conventional-kit
uv tool install .
...
```bash
conventional-kit check commit -m "feat: add login"
# commit: ok
conventional-kit check commit -f .git/COMMIT_EDITMSG
printf 'feat: add login\n' | conventional-kit check commit
```
...
```bash
conventional-kit check branch -n feat/add-login
# branch: ok
conventional-kit check branch
```
...
```bash
conventional-kit create commit --type feat --description "add login"
# feat: add login
conventional-kit create branch --type feature --description "add login"
# feature/add-login
```
...
```bash
conventional-kit hook install --target ../my-repo
conventional-kit hook install --target ../my-repo --force
conventional-kit hook uninstall --target ../my-repo
```
...
```python
from conventional_kit.branch import rules as branch_rules
...
Use `conventional-kit <command> --help` for the full option descriptions.

## Configuration

Create `.conventional-kit.toml` in the current repository:
